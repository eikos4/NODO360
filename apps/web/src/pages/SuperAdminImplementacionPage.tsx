        ...
        <section className="bg-white dark:bg-slate-900 border border-red-200 dark:border-red-900/40 rounded-2xl p-5 space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mb-2">
              Se carga en <strong>{workspace.name}</strong>. Columnas: RUT, Nombres, Apellidos, Correo, Teléfono, Contraseña, Rol, Compañía, N° operativo, Maquinista. Varios cargos en Rol separados por <code>|</code>, ej. <code>CAPITAN|BOMBERO|ENCARGADO_MATERIAL</code>. En Maquinista usá <code>si</code> si también conduce. Admin y Super Admin pueden ir sin compañía y con N° propio (666, 999).
            </p>
