...
export const ROLES: RoleMeta[] = [
  ...
  { value: 'OPERADOR_CENTRAL', label: 'Centralista · Sala de radio', short: 'Centralista', color: 'from-red-700 to-red-900', badge: 'bg-red-600/15 text-red-700 dark:bg-red-600/25 dark:text-red-300 border-red-500/30', icon: Radio, iconClass: 'text-red-600 dark:text-red-300' },
