...
export const CENTRAL_PARRAL_THEMES: Record<CentralParralThemeId, CentralParralThemeTokens> = {
  ...
  light: {
    ...
    activeKeyEmpty: 'border-orange-300 bg-orange-50',
    activeKeyEmptyText: 'text-orange-950',
    ...
    voicePreviewLabel: 'text-slate-700',
    voiceText: 'text-slate-800',
    footer: 'text-slate-700',
    vehicleThumb: 'bg-slate-100 border-slate-200',
    vehiclePatent: 'text-slate-900',
    vehicleMeta: 'text-slate-700',
    personnelEmpty: 'text-slate-700',
    hint: 'text-slate-700',
    mapTheme: 'light',
